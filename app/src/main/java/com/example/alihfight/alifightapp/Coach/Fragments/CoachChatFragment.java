...
public class CoachChatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_coach_chat, container, false);

        linearLayoutManager = new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false);
        Recyclerview = view.findViewById(R.id.recyclerChatCoach);
                ...
                if (dataSnapshot.exists()){
                    ...
                    FirebaseRecyclerAdapter<DataChatHeader, ChatHeaderViewHolder> firebaseRecyclerAdapter =
                            new FirebaseRecyclerAdapter<DataChatHeader, ChatHeaderViewHolder>(
                                    ...
                                    childRef.child(dataSnapshot.child("SessionInstructor").getValue().toString())
                            ) {
                                @Override
